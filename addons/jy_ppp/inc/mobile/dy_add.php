				...
				if($op=='add')
				{
					...
					if(!empty($sex))
					{
						if(empty($member))
						{
							...
							$blank=0;
							$lifestatus_arr=array('早睡早起','偶尔熬夜','经常熬夜','经常懒散','没有规律');
							...
							if(empty($lifestatus))
							{
						        ...
						        $jobstatus_arr=array('轻松稳定','朝九晚五','偶尔加班','经常加班','偶尔出差','经常出差','经常应酬','工作时间自由');
							...
							$companytype_arr=array('政府机关','事业单位','外企单位','世界500强','上市公司','国有企业','私营企业','自有公司');
							...
							$smoke_arr=array('不吸很反感','不吸烟但不反感','社交时偶尔吸','经常吸烟');
							if(!empty($smoke_arr))
							{
							...
							$parentstatus_arr=array('父母健在','单亲家庭','父亲健在','母亲健在','父母均离世');
							...
							$chuyi_arr=array('色香味俱全','能做几样可口的小菜','不太会但愿为心爱的人学习');
							if(!empty($chuyi_arr))
							{
								$chuyi=array_rand($chuyi_arr);
								$chuyi=$chuyi_arr[$chuyi];
							}
							if(empty($chuyi))
							{
								$chuyi=0;
